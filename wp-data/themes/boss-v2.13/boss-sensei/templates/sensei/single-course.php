...
?>
	...
	?>
        	...
        	<article <?php post_class( array( 'course', 'post' ) ); ?>>
                ...
                if ( ( is_user_logged_in() && $is_user_taking_course && 'full' == Sensei()->settings->get( 'course_single_content_display' ) )
                     || ( $access_permission && !$has_product_attached && 'full' == Sensei()->settings->get( 'course_single_content_display' ) )
                ) {
                    ...
                    echo '<p class="course-excerpt">' . get_post(  get_the_ID() )->post_excerpt . '</p>';
