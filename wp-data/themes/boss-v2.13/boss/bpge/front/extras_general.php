...
<p>
    ...
    <input type="radio" value="public" <?php echo checked($bp->groups->current_group->extras['display_page'], 'public', false); ?> name="group-extras-display"> <span><?php _e('Show it', 'bpge'); ?></span><br />
    <input type="radio" value="private" <?php echo checked($bp->groups->current_group->extras['display_page'], 'private', false); ?> name="group-extras-display"> <span><?php _e('Hide it', 'bpge'); ?></span>
</p>
...
<p>
    ...
    <input type="radio" value="plain" <?php echo checked($bp->groups->current_group->extras['display_page_layout'], 'plain', false); ?> name="group-extras-display-layout"> <span><?php _e('Plain (field title and its data below)', 'bpge'); ?></span><br />
    <input type="radio" value="profile" <?php echo checked($bp->groups->current_group->extras['display_page_layout'], 'profile', false); ?> name="group-extras-display-layout"> <span><?php _e('Profile style (in a table)', 'bpge'); ?></span>
</p>
...
<p>
    ...
    <input type="radio" value="public" <?php echo checked($bp->groups->current_group->extras['display_gpages'], 'public', false); ?> name="group-gpages-display"> <span><?php _e('Show it', 'bpge'); ?></span><br />
    <input type="radio" value="private" <?php echo checked($bp->groups->current_group->extras['display_gpages'], 'private', false); ?> name="group-gpages-display"> <span><?php _e('Hide it', 'bpge'); ?></span>
</p>

<hr />

<label><?php _e('You can reorder here all navigation links in this group. The first item will become a landing page for this group. Save changes after reordering.<br /><br />Please do NOT make Admin/Manage pages on first place - that will cause display problems.', 'bpge'); ?></label>
<ul id="nav-sortable">
    <?php
