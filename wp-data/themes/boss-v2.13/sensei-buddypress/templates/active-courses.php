...
$courses_html = bp_sensei_get_active_courses_html();
...
<div id="my-courses">
    ...
    <div id="active-courses">
        ...
        <?php if ( '' != $courses_html['active_html'] ) {
            ...
            <div id="message" class="info"><p><?php echo $courses_html['no_active_message']; ?> <a href="<?php echo $course_page_url; ?>"><?php apply_filters( 'sensei_start_a_course_text', _e( 'Take a Course!', 'sensei-buddypress' ) ); ?></a></p></div>
