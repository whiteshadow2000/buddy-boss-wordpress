                ...
                <div class="left-col">
                    <div class="table">
                        ...
                        <div class="header-links">
                            ...
                            <a href="<?php echo bp_core_get_user_domain( get_current_user_id() ); ?>" class="profile-ico icon" title="<?php _e('Profile','boss'); ?>">
...
<div id="mobile-header" class="table <?php echo (get_option('boss_adminbar') == 'on')?'with-adminbar':''; ?>"> 
  <!-- Toolbar for Mobile -->
...
<div id="panels" class="<?php echo (get_option('boss_adminbar') == 'on')?'with-adminbar':''; ?>">
