...
function buddyboss_slides_posttype() {
    register_post_type( 'buddyboss_slides',
        array(
            'labels' => array(
                'name' => __( 'Slides', 'buddyboss' ),
                'singular_name' => __( 'Slide', 'buddyboss' ),
                'add_new' => __( 'Add New', 'buddyboss' ),
                'add_new_item' => __( 'Add New Slide', 'buddyboss' ),
                'edit_item' => __( 'Edit Slide', 'buddyboss' ),
                'new_item' => __( 'Add New Slide', 'buddyboss' ),
                'view_item' => __( 'View Slide', 'buddyboss' ),
                'search_items' => __( 'Search Slides', 'buddyboss' ),
                'not_found' => __( 'No Slides found', 'buddyboss' ),
                'not_found_in_trash' => __( 'No Slides found in trash', 'buddyboss' )
            ),
            'public' => false,
...
add_action( 'wp_enqueue_scripts', 'buddyboss_slides_assets' );
?>