...
class BuddyBossLoginWidget extends WP_Widget
{
  function __construct()
  {
    ...
    $this->WP_Widget('BuddyBossLoginWidget', '(BuddyBoss) Profile Login Widget', $widget_ops);
  }
          ...
          if ( function_exists('bp_is_active') ) :
              ...
              echo "<div id='sidebarme'>";
                  ...
                  echo "<ul class='sidebarme-quicklinks'>";
                    ...
                    echo "<li class='sidebarme-profile'>";
                      echo "<a href='".bp_loggedin_user_domain()."profile/edit'>".__( 'Edit Profile' , 'buddyboss' )."</a>";
                      echo " &middot; ";
                      echo wp_loginout();
                    echo "</li>";
                  echo "</ul>";
            ...
            // check if user is logged out
              ...
              echo "<form name='login-form' id='sidebar-login-form' class='standard-form' action='".site_url( 'wp-login.php', 'login_post' )."' method='post'>";
                echo "<label>".__( 'Username', 'buddyboss' )."</label>";
                ...
                echo "<label>".__( 'Password', 'buddyboss' )."</label>";
                ...
                echo "<input type='submit' name='wp-submit' id='sidebar-wp-submit' value='".__( 'Log In', 'buddyboss' )."' tabindex='100' />";

                if ( bp_get_signup_allowed() ) {
                  echo " <a class='sidebar-wp-register' href='".bp_get_signup_page()."'>".__( 'Register', 'buddyboss' )."</a>";
                }
