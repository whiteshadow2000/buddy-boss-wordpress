	...
	<li class="bbp-topic-title">
		...
		<div class="bbp-topic-title-content">
			...
			<p class="bbp-topic-meta">
				...
				<div class="bbp-topic-started-by"><?php printf( __( 'Started by: %1$s', 'buddyboss' ), bbp_get_topic_author_link( array( 'size' => '14' ) ) ); ?></div>
				...
				<?php if ( !bbp_is_single_forum() || ( bbp_get_topic_forum_id() != bbp_get_forum_id() ) ) : ?>
					...
					<div class="bbp-topic-started-in"><?php printf( __( 'in: <a href="%1$s">%2$s</a>', 'buddyboss' ), bbp_get_forum_permalink( bbp_get_topic_forum_id() ), bbp_get_forum_title( bbp_get_topic_forum_id() ) ); ?></div>
