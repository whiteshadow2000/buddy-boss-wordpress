...
class BuddyBoss_Media_Type_Photo extends BP_Component
{
	...
	*/
	...
	public function minified_assets()
	{
		...
		// JS > Main
//		wp_enqueue_script( 'buddyboss-media-main', $assets . '/js/buddyboss-media.js', array( 'jquery', 'plupload', 'jquery-fancybox' ), '3.0.6', true );
		wp_enqueue_script( 'buddyboss-media-main', $assets . '/js/buddyboss-media.min.js', array( 'jquery', 'plupload', 'jquery-fancybox' ), '3.0.6', true );
